# Generated by Powerlevel10k configuration wizard on 2023-05-03 at 21:53 BST.
...
# 2 lines, solid, left frame, black-ornaments, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    # Show worktree name if there are multiple worktrees
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=10
